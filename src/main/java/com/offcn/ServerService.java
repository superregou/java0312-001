 ...
 * 
 */
@WebServiceClient(name = "ServerService", targetNamespace = "http://offcn.com/", wsdlLocation = "http://localhost:9901/Service/hello?wsdl")
public class ServerService extends Service {
	...
	static {
		...
		try {
			...
			url = new URL(baseUrl, "http://localhost:9901/Service/hello?wsdl");
		} catch (MalformedURLException e) {
			logger.warning(
					"Failed to create URL for the wsdl Location: 'http://localhost:9901/Service/hello?wsdl', retrying as a local file");
